		...
		<table class="table table-striped" border="0" cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td class="sl_t_title"><?php echo sl_show_anchor('blogs/view/'.$value['id'],$value['title'],array('sl_page'=>$this->uri->segment(2))) ?></td>
					<td class="sl_t_count"><?php echo $value['blog_comments_count'] ?></td>			
