...
class Portfolios extends SL_Controller {
	...
	public function index($page = 0) {
		...
		$this -> layout -> render('blogs/index', array('common_data'=>$this->common_data,'data' => $data));
	}
	...
	public function view($id) {
		...
		$this -> layout -> render('communities/view', array('common_data'=>$this->common_data,'data' => $data));
	}
